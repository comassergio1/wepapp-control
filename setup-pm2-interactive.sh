...
echo "🔐 Cuando pida la contraseña, introdúcela manualmente"
...
echo "🔐 Se te pedirá la contraseña SSH nuevamente..."
...
echo "   ssh -p $SSH_PORT $SSH_USER@$SSH_HOST 'cd $SSH_PATH && pm2 status'" 